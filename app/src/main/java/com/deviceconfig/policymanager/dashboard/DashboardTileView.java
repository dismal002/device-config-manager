...
import com.deviceconfig.policymanager.Utils;
...
public class DashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (mTile != null) {
            // Check if we have a tile ID in extras (our custom handling)
            if (mTile.extras != null && mTile.extras.containsKey("TILE_ID")) {
                String tileId = mTile.extras.getString("TILE_ID");
                if (getContext() instanceof com.deviceconfig.policymanager.MainActivity) {
                    ((com.deviceconfig.policymanager.MainActivity) getContext()).onTileClicked(tileId, mTile);
                }
            } else if (mTile.fragment != null) {
